!function() {
    ...
    var e, i = {
        ...
        xl: 1540,
        xxl: 1840
    }, o = window.innerWidth, r = window.innerHeight, c = 0, s = [];
    function l() {
        o = window.innerWidth,
    ...
    var u, t = 1e3, v = !1, m = /Firefox/i.test(navigator.userAgent), h = !1, f = {
        body: document.body,
        activeZone: 1
    };
    function p(e) {
    ...
    function y(e) {
        ...
        if (1 !== n.length || n[0].hash !== e) {
            ...
            p(a),
            6 === f.activeZone ? f.mainNav.classList.add("hide-nav-btn") : 3 === f.activeZone ? f.body.classList.add("light-zone") : (f.mainNav.classList.remove("hide-nav-btn"),
            f.body.classList.remove("light-zone"))
        }
    }
    function b() {
        v = !0,
    ...
    function g(e) {
        var t;
        (e.preventDefault(),
        v) || ((t = m ? -33.334 * e.detail : void 0 !== e.deltaY ? -e.deltaY : e.wheelDelta) <= -15 && w(e, "next", t),
        15 <= t && w(e, "prev", t))
    }
    var L = {
        rootMargin: "0% 50%",
      ...
      , x = function(e, n) {
        e.forEach(function(e) {
            if (e.intersectionRatio >= L.threshold) {
                ...
                L.once || e.target.classList.remove(L.animateClassName)
        })
    }
      , S = function() {
        k(),
      ...
      , O = function() {
        ...
        (n = [].filter.call(document.querySelectorAll(L.selector), function(e) {
            return t = e,
            L.animateClassName,
            !t.classList.contains(L.animateClassName);
            var t
        })).forEach(function(e) {
            return T.observe(e)
        })
        ...
        a && a.addEventListener("submit", function(e) {
                        ...
                        if ("" !== e.elements[t].name)
                            ...
                            case "SELECT":
                                ...
                                case "select-multiple":
                                    for (n = e.elements[t].options.length - 1; 0 <= n; n -= 1)
                                        e.elements[t].options[n].selected && a.push("".concat(e.elements[t].name, "=").concat(encodeURIComponent(e.elements[t].options[n].value)))
                                }
                                break;
                            case "BUTTON":
                                switch (e.elements[t].type) {
            ...
            t.onreadystatechange = function() {
                if (this.readyState === this.DONE && t.onreadystatechange)
                    ...
                    "ok" !== JSON.parse(this.responseText).status)
                        alert("fejl opstod i mailcontroller");
                    else {
            ...
            ,
            t.open("POST", "/umbraco/api/mail/sendmultinestedcontent", !0),
    ...
    function N(e) {
        ...
        return new Promise(function(t) {
            n.addEventListener("load", function() {
                return (e = n,
                "decode"in e ? e.decode().then(function() {
                    return e
    ...
    function I(n) {
        ...
        return Object.keys(i).forEach(function(e, t) {
            t <= c && o < t && (a = n.getAttribute("data-src-".concat(e)) || a,
            o = t)
        }),
        a || (a = n.getAttribute("data-src-xxs")),
        a
    }
    function q(e) {
        var t = I(e);
    ...
    var P, z = function() {
        function i(e) {
            ...
            this.dom.sections = this.dom.container.querySelectorAll(".slider__section"),
            this.activeIndex = 0,
            this.activeBtn = this.dom.btns[0],
            this.activeIcon = null,
            this.setSliderHeightWidth(),
            t = this.setSliderHeightWidth.bind(this),
            s.push(t);
            for (var a = function(t) {
                n.dom.icons[t].addEventListener("click", function(e) {
                    return n.swapContent(e, t + 1)
                })
            }, o = 0; o < this.dom.icons.length; o += 1)
                a(o)
        }
        var e, t, n;
        return e = i,
        (t = [{
            ...
            value: function() {
                var n = this
                  , a = [];
                this.dom.container.classList.remove("slider--loaded"),
                ...
                for (var e = function(t) {
                    ...
                    a.push(e.scrollHeight),
                    e.removeAttribute("style"),
                    n.dom.btns[t].addEventListener("click", function(e) {
                        return n.swapContent(e, t)
                    })
                }, t = 0; t < this.dom.sections.length; t += 1)
                    e(t);
            ...
            value: function(e, t) {
                ...
                t !== this.activeIndex) {
                    ...
                    this.dom.wrap.scrollHeight < n.offsetHeight && TweenLite.to(this.dom.wrap, .5, {
            ...
            key: "swapActiveBtn",
            value: function(e) {
                if (this.activeBtn.classList.remove("active"),
                this.dom.btns[e].classList.add("active"),
                this.activeBtn = this.dom.btns[e],
                this.dom.icons.length) {
                    if (0 === e)
                        return void this.activeIcon.classList.remove("active");
                    var t = this.dom.icons[e - 1];
                    this.activeIcon && this.activeIcon.classList.remove("active"),
    ...
    !function() {
        f.sliders = f.body.querySelectorAll(".slider"),
        f.zones = f.body.querySelectorAll(".zone"),
        l(),
        window.addEventListener("resize", d),
        window.addEventListener("orientationchange", d);
        for (var e = f.body.querySelectorAll(".zone__image"), t = f.body.querySelectorAll(".lazy__image"), n = 0; n < e.length; n += 1)
            q(e[n]);
        for (var a = 0; a < t.length; a += 1)
            C(t[a]);
        !function(e, t) {
            f.mainNav = f.body.querySelector(e),
            f.navLinks = f.mainNav.querySelectorAll(t),
            f.mainNav.classList.remove("nav--hidden");
            for (var n = f.body.querySelectorAll(".block__link[href^='#zone'], .btn[href^='#zone']"), a = 0; a < n.length; a += 1)
                n[a].addEventListener("click", w);
            ...
            TweenMax.staggerFrom(f.navLinks, .4, {
                ...
                var e;
                o && 778 < window.pageYOffset ? (e = f.navLinks[o - 1],
                f.activeZone = o,
                6 === f.activeZone ? f.mainNav.classList.add("hide-nav-btn") : 3 === f.activeZone && f.body.classList.add("light-zone")) : e = f.navLinks[0],
                TweenLite.set(e, {
                    className: "+=active showTitle"
                }),
                p(e),
            ...
            for (var i = 0; i < f.navLinks.length; i += 1)
                f.navLinks[i].addEventListener("click", w);
        ...
        3 <= c && f.body.querySelector(".btn--reveal").addEventListener("click", Z),
